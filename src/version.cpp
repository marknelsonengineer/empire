...
[[maybe_unused]] alignas( int ) const_build_number_t VERSION_BUILD { 456 };

[[maybe_unused]] alignas( const std::string ) constinit const std::string FULL_VERSION { "5.0.0+456" };
